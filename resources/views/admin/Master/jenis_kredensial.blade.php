...
@section('main')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Master Jenis Kredensial</h1>
        </div>
        <!-- Content Row -->
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" id="div_nama">
                        ...
                        {{Form::text('nama_jenis','',['class' => 'form-control', 'id' => 'nama_jenis', 'placeholder' => 'Jenis Kredensial...'])}}
                    </div>
                </div>
...
<script>
    $(document).ready( function () {
        var table = $('#table').DataTable( {
            ...
            ajax: "{{ url('/admin/jenis-kredensial/data') }}",
                "columns": [
                    {
                        "data": "id_jenis_kredensial",
                        class: "text-center",
    ...
    $(document).on('click', '#add', function() {
        $('#modal').modal('show');  
        $('#nama_jenis').val("");
        $('#form').attr('action', '{{ url('admin/jenis-kredensial/create') }}');     
    });
    ...
    $(document).on('click', '#edit', function() {
        ...
        $.ajax({   
            type: "get",
            url: "{{ url('/admin/jenis-kredensial/edit') }}/"+id,
            dataType: "json",
            success: function(data) {
                ...
                $('#form').attr('action', '{{ url('admin/jenis-kredensial/update') }}/'+id);
            }
        });        
    });
    ...
    $(document).on('click', '#delete', function() {
            ...
            if (confirm("Anda Yakin ingin menghapus data?")){
                $.ajax({
                    url : "{{ url('admin/jenis-kredensial/delete') }}/"+id,
                    success :function () {
                        location.reload();
                    }
                })
